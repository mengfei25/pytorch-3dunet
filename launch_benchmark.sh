...
function main {
    ...
    sed -i "s+PATH_TO_CKPT+${CKPT_DIR}+g;s+PATH_TO_DATADIR+${DATASET_DIR}+g" \
                resources/3DUnet_confocal_boundary/test_config.yml
    ...
    do
        # cache
        predict3dunet --config resources/3DUnet_confocal_boundary/test_config.yml \
            --batch_size 1 \
